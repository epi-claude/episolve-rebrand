...
const comparisonPoints = [
  { item: "Senior technology leadership", fractional: true, fullTime: true },
  { item: "Multi-year technology roadmap", fractional: true, fullTime: true },
  { item: "Vendor evaluation & management", fractional: true, fullTime: true },
  { item: "Budget planning & optimization", fractional: true, fullTime: true },
  { item: "Diverse team of specialists", fractional: true, fullTime: false },
  { item: "No hiring or onboarding delays", fractional: true, fullTime: false },
  { item: "No benefits, insurance, or overhead", fractional: true, fullTime: false },
  { item: "Scalable engagement model", fractional: true, fullTime: false },
  { item: "Cross-industry expertise", fractional: true, fullTime: false },
  { item: "Risk of single point of failure", fractional: false, fullTime: true },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground text-lg">
                ...
                <p>
                  For most not-for-profit organizations, this model doesn't make financial sense—and it doesn't have to.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="p-8 rounded-2xl card-gradient border border-border">
                ...
                <div className="space-y-4">
                  {[
                    "Technology strategy aligned to your 3-year plan",
                    "Vendor evaluation, selection, and management",
                    "Multi-year IT budgeting and spend optimization",
                    "Security posture and compliance oversight",
                    "Cloud infrastructure planning and migration",
                    "Software selection and integration strategy",
